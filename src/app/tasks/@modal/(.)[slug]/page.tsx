...
const TaskModal = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  return (
    <>
      <div className='fixed inset-0 w-screen min-h-screen bg-black/60' />
      <div className='border bg-background absolute z-[100] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-100 w-full rounded-lg p-4 shadow-md'>
        <div className='mb-4'>
